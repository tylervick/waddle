...
- libsndfile (streamed music: OGG, FLAC, WAV) — LGPL-2.1
  (LIBSNDFILE-LGPL.txt), © 1999-2018 Erik de Castro Lopo and contributors.
  Statically linked and conveyed as part of this GPL-3.0 application per LGPL §3, which permits conversion to GPL version 2 "or any
  later version", with complete source available at the repository above.
- libogg — BSD-3-Clause (LIBOGG-BSD.txt), © 2002 Xiph.org Foundation.
